...
@InputType()
class FavoriteCreateNestedManyWithoutApartmentsInput {
...
export { FavoriteCreateNestedManyWithoutApartmentsInput as FavoriteCreateNestedManyWithoutApartmentsInput };
